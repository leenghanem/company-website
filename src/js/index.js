...
$(function() {
    ...
    var pathname = window.location.pathname;//get the path they are in
    console.log(pathname);
    $('.navbar-nav > li > a[href="'+pathname+'"]').parent().addClass('active');
    
    //add an active class to the pages related to blog
    if (pathname == "/blog-details.html" || pathname == "/add-blog.html") {
      $('.navbar-nav > li > a[href="/blog.html"]').parent().addClass('active');
    }

    //add an active class to the pages related to project
